...
Так же можете ознакомится с форками jekyll
...
Это все конечно замечательно, однако помимо площадки нам желателен мощный и удобный инструмент для всего этого. Я решил воспользоваться [Obsidian](https://obsidian.md/), однако я вскоре узнал о том что он из под коробки никак не дружит с jekyll, нужно его настраивать отдельно, про это будут отдельные посты.
